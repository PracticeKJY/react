...
const virtualSwiper = h(
  "div",
  { className: "swiper realSwiper" },
  h(
    "div",
    { className: "swiper-wrapper" },
    h("div", { className: "swiper-slide" }, "슬라이드1"),
    h("div", { className: "swiper-slide" }, "슬라이드2")
  )
);

console.log(virtualSwiper);

// React가 만들어낸 가상 DOM 루트 노드
// console.log(virtualElement); // App

const actualElement = document.getElementById("root");
const swiperElement = document.getElementById("app");
...
const reactDomRoot2 = ReactDOM.createRoot(swiperElement);

reactDomRoot.render(virtualElement);
reactDomRoot2.render(virtualSwiper);
